...
won't clash or be obviated by ORY Herodot's normal direction. A great way to
do this is via
[ORY Herodot Discussions](https://github.com/ory/Herodot/discussions) or
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  Herodot. Github stars help the project gain visibility and stand out.
...
Check out
[ORY Herodot Discussions](https://github.com/ory/Herodot/discussions).
...
[docs](https://github.com/ory/Herodot/tree/master/docs) folder. Generate API
...
git clone git@github.com:ory/Herodot.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/Herodot.git
