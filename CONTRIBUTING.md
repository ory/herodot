...
_Please note_: We take ORY Herodot's security and our users' trust very
seriously. If you believe you have found a security issue in ORY Herodot,
...
do this is via
[ORY Herodot Discussions](https://github.com/ory/meta/discussions)
...
- I have a question. Where can I get
  [answers to questions regarding ORY Herodot?](#communication)
...
- I want to talk to other ORY Herodot users.
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out ORY Herodot.
...
- **Helping with open issues.** We have a lot of open issues for ORY Herodot
...
Check out [ORY Herodot Discussions](https://github.com/ory/meta/discussions). This is a great place for
...
If you want to receive regular notifications about updates to ORY Herodot,
...
before getting started to ensure your work is consistent with ORY Herodot's
...
[docs](https://github.com/ory/herodot/tree/master/docs) folder. Generate API and
configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/herodot/blob/master/README.md).
...
1. Ensure that each commit has a subsystem prefix (ex: `controller:`).
   [List of subsystem prefixes for Herodot](https://github.com/ory/ory/herodot/blob/master/.github/semantic.yml)
   (if applicable).
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the ORY Herodot
